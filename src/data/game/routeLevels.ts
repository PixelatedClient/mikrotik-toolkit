...
export const ROUTE_LEVELS: RouteLevel[] = [
  ...
  },
  {
    ...
    net: (): Net => ({
      nodes: [
        router('r1', 'R1', [['e1', '10.1.12.1', 30], ['e2', '10.1.14.1', 30]]),
        router('r2', 'R2', [['e1', '10.1.12.2', 30], ['e2', '10.2.23.1', 30]]),
        router('r3', 'R3', [['e1', '10.2.23.2', 30], ['e2', '10.3.34.1', 30]]),
        router('r4', 'R4', [['e1', '10.3.34.2', 30], ['e2', '10.1.14.2', 30]]),
        host('pc1', 'PC1', '192.168.1.10', 24, '10.1.12.1'),
        host('pc4', 'PC4', '192.168.4.10', 24, '10.1.14.2'),
      ],
      links: [
        { a: 'r1', ai: 'e1', b: 'r2', bi: 'e1', up: true },
        { a: 'r2', ai: 'e2', b: 'r3', bi: 'e1', up: true },
        { a: 'r3', ai: 'e2', b: 'r4', bi: 'e1', up: true },
        { a: 'r4', ai: 'e2', b: 'r1', bi: 'e2', up: true },
        { a: 'pc1', ai: 'e0', b: 'r1', bi: 'e1', up: true },
    ...
    solution: {
      r1: [
        { dst: '192.168.2.0/24', via: '10.1.12.2' },
        { dst: '192.168.3.0/24', via: '10.1.12.2' },
        { dst: '192.168.4.0/24', via: '10.1.14.2' },
      ],
      r2: [
        { dst: '192.168.1.0/24', via: '10.1.12.1' },
        { dst: '192.168.3.0/24', via: '10.2.23.2' },
        { dst: '192.168.4.0/24', via: '10.2.23.2' },
      ],
      r3: [
        { dst: '192.168.1.0/24', via: '10.2.23.1' },
        { dst: '192.168.2.0/24', via: '10.2.23.1' },
        { dst: '192.168.4.0/24', via: '10.3.34.2' },
      ],
      r4: [
        { dst: '192.168.1.0/24', via: '10.1.14.1' },
        { dst: '192.168.2.0/24', via: '10.3.34.1' },
        { dst: '192.168.3.0/24', via: '10.3.34.1' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    story: 'The enemy has splintered into three isolated castles: 172.20.0.0/24, 172.21.0.0/24, and 172.22.0.0/24. They do not share a common supernet. Route to each precisely.',
    learn: 'When subnets do not align neatly, you may need three routes where one supernet would be cleaner. This is real life: networks grow by accretion, not by design.',
    goal: 'Reach all three enemy castles.',
    net: (): Net => ({
      nodes: [
        host('army', 'Your army', '10.0.0.10', 24, '10.0.0.1'),
        router('r1', 'R1', [['e0', '10.0.0.1', 24], ['e1', '10.1.0.1', 30]]),
        router('r2', 'R2', [['e1', '10.1.0.2', 30], ['e2', '10.2.0.1', 30]]),
        router('r3', 'R3', [['e1', '10.2.0.2', 30], ['e2', '10.3.0.1', 30]]),
        host('castle1', 'Castle 1', '172.20.0.10', 24, '172.20.0.1'),
        host('castle2', 'Castle 2', '172.21.0.10', 24, '172.21.0.1'),
        host('castle3', 'Castle 3', '172.22.0.10', 24, '172.22.0.1'),
      ],
      links: [
        { a: 'army', ai: 'e0', b: 'r1', bi: 'e0', up: true },
        { a: 'r1', ai: 'e1', b: 'r2', bi: 'e1', up: true },
        { a: 'r2', ai: 'e2', b: 'r3', bi: 'e1', up: true },
        { a: 'r3', ai: 'e2', b: 'castle1', bi: 'e0', up: true },
        { a: 'r3', ai: 'e2', b: 'castle2', bi: 'e0', up: false },
        { a: 'r3', ai: 'e2', b: 'castle3', bi: 'e0', up: false },
      ],
    }),
    editable: ['r1', 'r2', 'r3'],
    flows: [
      { from: 'army', to: '172.20.0.10', label: 'Attack Castle 1' },
      { from: 'army', to: '172.21.0.10', label: 'Attack Castle 2' },
      { from: 'army', to: '172.22.0.10', label: 'Attack Castle 3' },
    ],
    par: 6,
    solution: {
      r1: [{ dst: '172.20.0.0/24', via: '10.1.0.2' }, { dst: '172.21.0.0/24', via: '10.1.0.2' }, { dst: '172.22.0.0/24', via: '10.1.0.2' }],
      r2: [{ dst: '172.20.0.0/24', via: '10.2.0.2' }, { dst: '172.21.0.0/24', via: '10.2.0.2' }, { dst: '172.22.0.0/24', via: '10.2.0.2' }],
      r3: [{ dst: '10.0.0.0/24', via: '10.2.0.1' }],
    },
  },
];
